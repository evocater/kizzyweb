...
function Qr({ onClose, wallet }) {
  ...
  const handleCopy = () => {
    navigator.clipboard
      ...
      .then(() => {
        setIsCopied(true);
        setTimeout(() => setIsCopied(false), 2500); // Resets after 2 seconds.
      })
    ...
    <div className="fixed top-0 left-0 right-0 bottom-0 z-50">
      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 bg-white rounded-t-lg p-4 z-60 flex flex-col items-center"
        ...
        >
          <div className="mt-4 text-center w-7/10 mx-auto">
            ...
            <div
              ...
              style={{ fontFamily: "G8321-ExtraBold", fontSize: "20px" }}
            >
              <span className="mr-2">get</span>
              <span className="text-[#6865FD] mr-1">kizzy coins</span>
              <Image
                src="/images/kizzy-coin-noshadow.png"
                alt="Kizzy Coin"
                width={24}
                height={24}
                className="mt-1 mx-1"
          ...
          <div className="mt-6 flex flex-col w-full items-start">
            <span
              style={{ fontFamily: "G8321-Regular", fontSize: "14px" }}
              className="text-[#9E9E9E] mb-2"
            >
              Select network
            </span>
            <div
          ...
          <div className="mt-4 border-2 border-[#C3C1FE] rounded-xl p-3">
          <QRCode value={wallet}  />
          </div>
