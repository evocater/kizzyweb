            ...
            {success
                    ...
                    <div className='flex justify-center items-center w-full h-full'>
                        <AnimatePresence>
                            ...
                            className='p-6 flex flex-col justify-center items-center gap-6 w-full h-full'>
                                <Image src="/images/success.png" width={74} height={74} alt="/" unoptimized />
                            <motion.p className='font-g8-bold text-[18px] text-white'>Bet Pending</motion.p>
                            <p className='font-g8-regular text-[14px] text-white text-center'>Success in the bet will be confirmed upon approval of the second-layer verification.</p>
                            <button 
                        style={{ 
                ...
                <div className="fixed bottom-4 flex items-center justify-between w-full px-4"> {/* Added w-full and px-4 here */}
                    ...
                    className={`${(loading || user.balance < number || number == 0) && "opacity-50"} bg-white text-[#6865FD] rounded-md flex items-center justify-center`}>
                    {loading
                    ?
                    <svg
                    aria-hidden="true"
